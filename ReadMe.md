...
<img src="https://i.imgur.com/Y5PJaYp.png" alt="CS-City" width="200" style="margin-right: 20px;">
...
This bot is made and managed by [ComicallyBad](https://github.com/comicallybad).
...
To clone and use the CS-City Bot, follow these steps:
...
1. Navigate to the [GitHub Issues Tab](https://github.com/comicallybad/CS-Cityt/issues). 
